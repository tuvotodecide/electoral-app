export default {
  ...
  guardiansApprovedMessage:
    "Tus guardianes aprobaron la recuperación de tu cuenta, recuperando datos...",
  noRecoveryDni:
    "No se encontró el DNI de recuperación. Regresa e inténtalo de nuevo.",
  ...
  faceMatchFailedError:
    "La selfie no coincide con la foto del DNI. Por favor, vuelve a capturar tus imágenes asegurándote de que tu rostro esté claramente visible.",
  missingDataError:
    "Faltan datos en las imágenes. Por favor, vuelve a capturar asegurándote de que las fotos sean claras y completas.",
  analysisUnavailableError:
    "El análisis no está disponible temporalmente. Por favor, vuelve a intentar más tarde.",
  defaultVerificationError:
    "Error de verificación. Vuelve a intentar más tarde o intenta con fotos más nítidas.",
  ...
  migratingOnLogin:
    "Estamos migrando su cuenta a la nueva versión, por favor espere...",
  noBiometricData:
    "No se encontró tu credencial local. Vuelve a registrarte para emitir una nueva credencial.",
  ...
  biometricRejected:
    "No se pudo registrar tu cuenta porque se canceló el proceso de cambio biométrico. Por favor, vuelve a intentarlo y asegúrate de completar el proceso de cambio biométrico si has seleccionado esa opción.",
  ...
  qrValid: "Qr válido",
  legacyDataFound:
    "Los datos de este QR son antiguos, se realizará un proceso de migración",
  notEnoughLegacyData: "Este QR no tiene suficientes datos",
  alreadyMigrated:
    "Esta cuenta ya fue migrada, intente recuperar usando su Carnet y PIN",
  ...
  backupFileWarning: "Guarda este archivo en un lugar seguro.",
  ...
  enterPinVoteDescription:
    "Ingresa tu PIN de acceso para verificar tu identidad y continuar con el voto.",
  ...
  sharedSessionMessage:
    "¿Deseas compartir tu sesión actual con otra aplicación?",
  ...
  recoverySuccess:
    "Sus datos fueron recuperados, ingrese su PIN a continuación para iniciar sesión",
  ...
  initApp: "Iniciando...",
  downloadPromptTitle: "Descarga de archivos de verificación",
  downloadPromptMessage:
    "Para permitir tu participación de forma segura y privada, se necesita descargar {size} MB en archivos criptográficos (ZK).",
  downloadPromptMessageUnknownSize:
    "Para permitir tu participación de forma segura y privada, se necesita descargar archivos criptográficos (ZK).",
  exitApp: "Salir",
  ...
  pleaseSelectDocument:
    "Por favor, selecciona una hoja de trabajo para continuar.",
  ...
  actaUploadingDescription:
    "Tu hoja de trabajo se está subiendo en segundo plano",
  ...
  deviceNotFound:
    "No tiene una sesión en este dispositivo, regístrese o recupere su cuenta por favor.",
  ...
  claimCredendialsDesc:
    "Reclama tus credenciales para participar en esta votación.",
  ...
  claimError:
    "Error al reclamar credenciales, inténtalo de nuevo o contacta al soporte si el problema persiste.",
  credentialsClaimedDesc:
    "Tus credenciales han sido reclamadas exitosamente, ahora puedes ir a la votación.",

  //Migration
  migrationModalDesc:
    "Se ha detectado un respaldo antiguo en tu dispositivo. Para continuar, debes migrar tu respaldo a la nueva versión de la aplicación. Esto tomará un minuto.",
  migrateBackup: "Migrar Respaldo",
  migrationInProgress: "Migración en progreso...",
  migrationSuccess: "Migración completada exitosamente",
  migrationError:
    "Error durante la migración, inténtalo de nuevo o contacta al soporte si el problema persiste.",
